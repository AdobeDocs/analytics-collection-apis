...
| Generated timestamp | `t` | — | The auto-generated date/time of the hit, in the format `dd/mm/yyyy hh:mm:ss w o`:\<ul\>\<li\>`dd/mm/yyyy hh:mm:ss`: date/time in JavaScript (month `0` is January, `11` is December)\</li\>\<li\>`w`: day of the week (`0` Sunday, `6` Saturday)\</li\>\<li\>`o`: negative GMT offset in minutes (for example, `420` is GMT-7)\</li\>\</ul\>For a custom timestamp, use the Timestamp variable instead. |
...
| Link type | `pe` | `<linkType>` | The type of link. Defaults to a custom link when a link name is present.\<br/\>Query values:\<ul\>\<li\>`lnk_d`: Download link\</li\>\<li\>`lnk_e`: Exit link\</li\>\<li\>`lnk_o`: Custom link\</li\>\<li\>`tnt`: Analytics for Target\</li\>\</ul\>XML values:\<ul\>\<li\>`d`: Download link\</li\>\<li\>`e`: Exit link\</li\>\<li\>`o`: Custom link\</li\>\</ul\> |
